...
namespace MvcChallenge.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,Price,Size,OrderId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,Price,Size,OrderId")] Product product)
        {
            if (ModelState.IsValid)
            {
